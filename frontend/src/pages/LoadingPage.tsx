  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center flex-1 w-full max-w-md px-4">
        {/* 타이틀 */}
        <h2 className="text-[#090A0A] text-[24px] font-bold font-Inter text-center mt-32">
          리포트 생성 중
        </h2>
        ...
        {/* 푸시 알림 안내 버튼 */}
        <button className="w-[330px] bg-black rounded-[30px] px-8 py-4 text-white text-base font-bold font-Inter text-center mt-24">
          🔔 결과 분석 완료 푸쉬 알림 받기
        </button>
      </div>
    </>
